...
I've heard good things about the interactive exercises/tutorials at [SQLZoo](https://sqlzoo.net) and the book Practical SQL by Anthony DeBarros (available through Berkeley's Oskicat library catalog); in particular the first 200 or so pages (through chapter 12) cover general SQL programming/querying.
